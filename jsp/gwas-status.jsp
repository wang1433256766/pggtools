    ...
    <body>
        ...
        <div class="secend-nav">
            <ul>
                ...
                <li role="presentation" ><a href="/gwas-submit">Submit</a></li>
                <li role="presentation" class="active"><a href="/gwas-status">Status</a></li>
                <li role="presentation"><a href="/gwas-upload">Upload</a></li>
                <div class="imputation-server text-right">
                    <p>PGG Imputation Server &nbsp;&nbsp;&nbsp; <span class="label label-warning label-color">Beta</span></p>
                </div>
            </ul>
        </div>       
        <br>
